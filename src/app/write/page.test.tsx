...
describe('/write page', () => {
  test('paints the editor at first paint, before Clerk resolves — no spinner', () => {
  ...
  test('never reads categories from the server while signed out', () => {
    // Arrange
  ...
  test('tells the editor the category list is still in flight, so it stops inviting a keep', () => {
  ...
  test('never reports pending while signed out, where a disabled query is pending forever', () => {
  ...
  test("hands a signed-in visitor their account's categories", () => {
    // Arrange
    clerkUserRef.current = { isLoaded: true, isSignedIn: true }
  ...
  test('listens for categories changed in another window', () => {
