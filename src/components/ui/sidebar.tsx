...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90% — lazy init runs once per skeleton instance.
