...
describe('Toaster theme resolution', () => {
  test('passes system through verbatim so toasts follow the OS until a theme is picked', () => {
    // Arrange
  ...
  test('resolves a *-dark family id down to the dark mode Sonner accepts', () => {
  ...
  test('defaults to system before hydration when theme is undefined', () => {
    // Arrange
