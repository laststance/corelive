...
The `ThemeSelector` component provides a user-friendly interface for switching between different themes in the CoreLive application. It supports over 100 themes across various categories including free themes, harmonized color palettes, and premium themes.
...
- **100+ Themes**: Extensive collection of themes across different categories
...
- **CoreLive Base**: Extended light and dark themes with additional tokens
- **Traditional TODO**: Classic TODO app themes
- **Harmonized Palette**: 10 color schemes (5 colors × 2 modes)

### Premium Themes

- **Dark Themes** (30 variants): Midnight, Charcoal, Obsidian, Noir, Shadow
- **Light Themes** (20 variants): Pearl, Snow, Cream, Alabaster, Ivory
- **Gradient Themes** (20 variants): Aurora, Sunset, Ocean, Forest, Nebula
- **Retro Themes** (15 variants): Synthwave, Terminal, Vaporwave, Sepia, Neon
- **Seasonal Themes** (15 variants): Spring Blossom, Summer Beach, Autumn Forest, Winter Snow, Holiday
