...
describe('getHeatmapIntensityFromCount', () => {
  test('shows the coolest level on a rest day with nothing completed', () => {
    // Arrange
    const dayCount = 0
  ...
  test('warms to the started band on the very first completion', () => {
    // Arrange
    const dayCount = 1
  ...
  test('stays in the started band through three completions', () => {
  ...
  test('crosses into the good-day band at four completions', () => {
    // Arrange
    const dayCount = 4
  ...
  test('holds the good-day band through nine completions', () => {
    // Arrange
    const dayCount = 9
  ...
  test('crosses into the full-day band at ten completions', () => {
    // Arrange
    const dayCount = 10
  ...
  test('holds the full-day band through nineteen completions', () => {
    // Arrange
    const dayCount = 19
  ...
  test('reaches cathedral-lit at twenty completions', () => {
    // Arrange
    const dayCount = 20
  ...
  test('stays cathedral-lit for an unusually huge count', () => {
    // Arrange
    const dayCount = 100
...
describe('HEATMAP_LEVEL_TOKENS', () => {
  test('lists the five --hm CSS tokens in cool-to-warm order so band index maps to token', () => {
    // Arrange / Act / Assert
...
describe('heatmap band thresholds', () => {
  test('locks the band boundaries so heatmap cells and the dialog never drift', () => {
