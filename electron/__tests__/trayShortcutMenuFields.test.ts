...
describe('trayShortcutMenuFields', () => {
  test('right-aligns a chord through Electron’s accelerator field', () => {
    // Arrange + Act
  ...
  test('appends a lone-modifier binding to the label as a glyph instead of the accelerator field', () => {
  ...
  test('shows the plain label for a corrupt lone-modifier value instead of leaking the sentinel', () => {
  ...
  test('shows the plain label with no hotkey when the binding is unset', () => {
    // Arrange + Act
  ...
  test('shows the plain label with no hotkey when the binding is undefined', () => {
