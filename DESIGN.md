...
| 2026-09-05 | Today Ember: one heatmap cell above the editor, lit or unlit only (level tokens 0 and 4, no 1–3 ramp — it is a lamp, not a grade). A keep sweeps it in 400ms; an undo snaps back with no reverse motion. Unreachable counts say so instead of showing 0                                                                                                                                                      |
