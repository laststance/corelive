...
- **Everything is configurable** — themes, sound, motion, copy, layout, density, all of it. If it's a design or UX choice, the user can set it to their own preference. Configuration is a **first-class, discoverable capability**, not a buried or grudging afterthought.
