...
| 2026-09-05 | LiveEditor textarea shows no focus line (no ring and no border-color change on focus): the writing surface is the whole panel, so the caret is the focus cue; the general "focus ring uses `--ring`" Input rule does not apply to it. Deliberate WCAG 2.4.7 trade-off, user request.                                                                                                                         |
